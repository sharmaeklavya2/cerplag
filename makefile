utils = util/pch_int_hmap.c util/vptr_int_hmap.c util/pch.c util/vptr.c util/int_stack.c
sources = $(utils) lexer.c parser.c parse_tree.c ast.c symbol.c ast_gen.c error.c
